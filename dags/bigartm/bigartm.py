...
with dag7:
    ...
    gen_bigartm_operator(name="bigartm_test_ngram", description="Two last years", number_of_topics=200,
                         filters={
                             "corpus": "main",
                             "source": None,
                             "datetime_from": None,
...
dag8 = DAG('NLPmonitor_BigARTMs_ngramized_yandex', catchup=False, max_active_runs=1, concurrency=7, default_args=default_args, schedule_interval=None)
with dag8:
    wait_for_basic_tms = PythonOperator(
        task_id="wait_for_basic_tms",
        python_callable=lambda: 0,
    ...
    gen_bigartm_operator(name="bigartm_test_ngram_yandex", description="Two last years", number_of_topics=200,
                         filters={
                             "corpus": "main",
                             "source": None,
                             "datetime_from": None,
    ...
    gen_bigartm_operator(name="bigartm_two_years_ngram_yandex", description="Two last years", number_of_topics=200,
                    filters={
                        "corpus": "main",
                        "source": None,
                        "datetime_from": date(2017, 11, 1),
    ...
    gen_bigartm_operator(name="bigartm_education_two_years_ngram_yandex", description="Two last years education", number_of_topics=150,
                         filters={
                        "corpus": "main",
                        "source": None,
                        "datetime_from": date(2017, 11, 1),
