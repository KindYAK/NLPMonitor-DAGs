...
# dag = DAG('Criterion_evaluations', catchup=False, concurrency=1, default_args=default_args, schedule_interval='30 14 * * *')
dag = DAG('Criterion_evaluations', catchup=False, concurrency=1, default_args=default_args, schedule_interval=None)
