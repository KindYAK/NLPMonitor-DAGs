...
# dag = DAG('Criterion_evaluations', catchup=False, default_args=default_args, schedule_interval='30 14 * * *')
dag = DAG('Criterion_evaluations', catchup=False, default_args=default_args, schedule_interval=None)
